...
export default function DashboardLayout({
  ...
  const effectiveUser = import.meta.env.DEV && !user ? {
    openId: 'demo-user',
    name: 'Demo Admin',
    email: 'demo@youngmoney.com',
    role: 'admin' as const,
  } : user;
  ...
  // Skip login screen in development
  if (!effectiveUser) {
  ...
  return (
    ...
    >
      <DashboardLayoutContent setSidebarWidth={setSidebarWidth} effectiveUser={effectiveUser}>
        {children}
