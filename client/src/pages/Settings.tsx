...
import { AlertCircle, Clock, RotateCcw, Zap } from "lucide-react";
  ...
  const handleResetRanking = async () => {
    ...
    try {
      const response = await fetch(
        `https://youngmoney-api-railway-production.up.railway.app/api/reset/ranking?time=${rankingResetTime}`,
        { method: "GET" }
      );
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Reseta o ranking de pontos de todos os usuários
          </CardDescription>
        </CardHeader>
